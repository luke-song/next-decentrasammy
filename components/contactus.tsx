...
{status.submitted ? (
    <div className='text-white text-xl font-bold px-4 py-3 rounded relative' role="alrt">Your message has been successfully sent. We will contact you very soon!</div>
) : (
    <>
    <input 
                id="companyName"
                ...
                value={inputs.email}
                />
                <textarea id="message" name="message" required maxLength={1048576} placeholder="Additional Information" className='bg-black text-white outline-none border-2 border-white rounded-3xl px-8 py-6 min-h-[16em]' onChange={handleOnChange}
